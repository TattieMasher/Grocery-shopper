...
INSERT INTO meal_ingredients_link (meal_id, ingredient_id, ingredient_quantity, ingredient_quantity_unit) VALUES
  (1, 1, 300.00, 'grams'), -- Chicken Fajitas with 300g of Chicken
  (1, 2, 200.00, 'grams'), -- Chicken Fajitas with 200g of Bell Peppers
  (1, 3, 150.00, 'grams'), -- Chicken Fajitas with 150g of Onions
  (2, 4, 400.00, 'grams'), -- Spaghetti Bolognese with 400g of Spaghetti
  (2, 5, 250.00, 'grams'), -- Spaghetti Bolognese with 250g of Beef Mince
  (2, 6, 300.00, 'grams'), -- Spaghetti Bolognese with 300g of Tomato Sauce
  (3, 1, 350.00, 'grams'), -- Caesar Salad with 350g of Chicken
  (3, 7, 100.00, 'grams'), -- Caesar Salad with 100g of Lettuce
  (3, 8, 50.00, 'grams');  -- Caesar Salad with 50g of Croutons
